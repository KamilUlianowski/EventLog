...
intellisense.annotate(jQuery, {
  ...
  'parseHTML': function() {
    ...
    ///   <param name="dbContext" type="Element">DOM element to serve as the dbContext in which the HTML fragment will be created</param>
  ...
  'proxy': function() {
    /// <signature>
    ///   <summary>Takes a function and returns a new one that will always have a particular dbContext.</summary>
    ///   <param name="function" type="Function">The function whose dbContext will be changed.</param>
    ///   <param name="dbContext" type="PlainObject">The object to which the dbContext (this) of the function should be set.</param>
    ///   <returns type="Function" />
    /// </signature>
    /// <signature>
    ///   <summary>Takes a function and returns a new one that will always have a particular dbContext.</summary>
    ///   <param name="dbContext" type="PlainObject">The object to which the dbContext of the function should be set.</param>
    ///   <param name="name" type="String">The name of the function whose dbContext will be changed (should be a property of the dbContext object).</param>
    ///   <returns type="Function" />
    /// </signature>
    /// <signature>
    ///   <summary>Takes a function and returns a new one that will always have a particular dbContext.</summary>
...
intellisense.annotate(_object, {
  ...
  'fireWith': function() {
    /// <signature>
    ///   <summary>Call all callbacks in a list with the given dbContext and arguments.</summary>
    ///   <param name="dbContext" type="">A reference to the dbContext in which the callbacks in the list should be fired.</param>
...
intellisense.annotate(_object, {
  ...
  'notifyWith': function() {
    /// <signature>
    ///   <summary>Call the progressCallbacks on a Deferred object with the given dbContext and args.</summary>
    ///   <param name="dbContext" type="Object">Context passed to the progressCallbacks as the this object.</param>
    ///   <param name="args" type="Object">Optional arguments that are passed to the progressCallbacks.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  ...
  'rejectWith': function() {
    /// <signature>
    ///   <summary>Reject a Deferred object and call any failCallbacks with the given dbContext and args.</summary>
    ///   <param name="dbContext" type="Object">Context passed to the failCallbacks as the this object.</param>
  ...
  'resolveWith': function() {
    /// <signature>
    ///   <summary>Resolve a Deferred object and call any doneCallbacks with the given dbContext and args.</summary>
    ///   <param name="dbContext" type="Object">Context passed to the doneCallbacks as the this object.</param>
...
intellisense.annotate(jQuery.fn, {
  'add': function() {
    ...
    ///   <summary>Add elements to the set of matched elements.</summary>
    ///   <param name="selector" type="String">A string representing a selector expression to find additional elements to add to the set of matched elements.</param>
    ///   <param name="dbContext" type="Element">The point in the document at which the selector should begin matching; similar to the dbContext argument of the $(selector, dbContext) method.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'addBack': function() {
  ...
  'closest': function() {
    ...
    ///   <summary>For each element in the set, get the first element that matches the selector by testing the element itself and traversing up through its ancestors in the DOM tree.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <param name="dbContext" type="Element">A DOM element within which a matching element may be found. If no dbContext is passed in then the dbContext of the jQuery set will be used instead.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>For each element in the set, get the first element that matches the selector by testing the element itself and traversing up through its ancestors in the DOM tree.</summary>
  ...
  'context': function() {
    /// <summary>The DOM node dbContext originally passed to jQuery(); if none was passed then dbContext will likely be the document.</summary>
    /// <returns type="Element" />
  },
  'css': function() {
    /// <signature>
  ...
  'id': function() {
    ...
    ///   <param name="id" type="String">An ID to search for, specified via the testId attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
  ...
  'init': function() {
    ...
    ///   <param name="dbContext" type="jQuery">A DOM Element, Document, or jQuery to use as dbContext</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Accepts a string containing a CSS selector which is then used to match a set of elements.</summary>
